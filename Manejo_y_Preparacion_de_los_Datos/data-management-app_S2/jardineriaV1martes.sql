...
-- Create the database
--comando para hacer la base de datos
CREATE DATABASE db_jardineria;
go


-- Select the database
--comando para usar la base de datos jardineria
USE db_jardineria;
go

-- Create the Office table
--comando para crear la tabla de oficina
...
--comando para crear la tabla empleado
...
--comando para crear la tabla gama producto
...
--comando para crear la tabla pedido
CREATE TABLE pedido (
...
--comando para crear la tabla producto
...
--comando para crear la tabla detalle_pedido
...
--comando para crear la tabla pago
CREATE TABLE pago (
  codigo_cliente INTEGER NOT NULL,
...
--Estos son ejemplos de inserción de datos en la tabla de oficina
...
--Estos son ejemplos de inserción de datos en la tabla de empleado
...
-- Insert sample data into the Product Line table
--Estos son ejemplos de insercion en la tabla gama producto
...
--Estos son ejemplos de inserción de datos en la tabla de cliente
...
--Estos son ejemplos de inserción de datos en la tabla pedido
...
--Estos son ejemplos de inserción de datos en la tabla producto
...
--Estos son ejemplos de inserción de datos en la tabla de detalle_pedido
...
--Estos son ejemplos de inserción de datos en la tabla de pago
...
--con este comando visualizamos toda la informacion de la tabla cliente
select * from cliente
--con este comando visualizamos todos los registros de la tabla empleado
select * from empleado 


select * from oficina

--este comando permite visualizar todos los datos de la tabla de gama producto
select * from gama_producto
--este comando sirve para visualizar todos los datos de la tabla pedido
select * from pedido
--este comando sirve para visualizar todos los datos de la tabla producto
select * from producto
--este producto sirve para visualizar todos los datos de la tabla detalle pedido
select * from detalle_pedido
--esta tabla sirve para visualizar todos los datos de la tabla pago
select * from pago


--obtiene el codigo de la oficina, ciudad de la tabla oficina
select codigo_oficina,ciudad from OFICINA;
go
--obtiene el nombre, codigo del jefe de la tabla empleado
...
--devuelve un listado nombre de empleados , apellidos y correo cuyo codigo del jefe es 7
select nombre,apellido1,apellido2,email 
from empleado where codigo_jefe = 7
go


--Devuelve el nombre , apellidos , puesto correo donde el empleado sea el jefe
select
    nombre,
...
--devuelve nombre, apellidos y el puesto del empleado de aquellos que no tengan puesto de representante de ventas
